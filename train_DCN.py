...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', default='/home/f321/mengming/code/OmniNet-20191204/ckpt_1e_4/Fisheye/Structured3D_Pro_full_500/OmniNet_DCN_V2/layer4/resnet50_rnn/lin-1BS3KS',
                        help='folder to output checkpoints')
    parser.add_argument('--logs', default='/home/f321/mengming/code/OmniNet-20191204/logs/Fisheye/Structured3D_Pro_full_500/OmniNet_DCN_V2/layer4/resnet50_rnn/lin-1BS3KS',
                        help='folder to logging')
    parser.add_argument('--pth', help='path to load saved checkpoint.(finetuning)')

    # Model related  resnet50_deform_v1,
    parser.add_argument('--backbone', default='resnet50_deform_v2',
    ...
    parser.add_argument('--train_root_dir', default='/home/f321/mengming/dataset/Structured3D_Pro_full_500/train',
                        help='root directory to training panorama dataset or fisheye dataset. '
                             'should contains img, label_cor subdirectories')
    parser.add_argument('--valid_root_dir', default='/home/f321/mengming/dataset/Structured3D_Pro_full_500/valid',
    ...
    device = torch.device('cpu' if args.no_cuda else 'cuda:2')
