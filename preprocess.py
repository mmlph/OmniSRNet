...
from util.omni_lsd_align import panoEdgeDetection, rotatePanorama

parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter)
# I/O related arguments
parser.add_argument('--img_glob', default='/home/pc/hdd/mengming/code/OmniNet/assets/demo.png', required=False,
                    help='NOTE: Remeber to quote your glob path.')
parser.add_argument('--output_dir', default='/home/pc/hdd/mengming/code/OmniNet/assets/preprocessed', required=False)
